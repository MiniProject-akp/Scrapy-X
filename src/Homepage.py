...
class HomePage(tk.Frame):
    def __init__(self, master, show_login, show_signup, show_helpdesk, show_dashboard, show_mainpage, show_guide):
        ...
        picture_image = Image.open("assets/tae.png")
        ...
        heading_label = tk.Label(self, text="Welcome to Scrapy-X", font=("Showcard Gothic", 20, "bold"), fg="orange", bg='yellow')
        ...
        login_button_window = self.canvas.create_window(10, 60, anchor=tk.NW, window=login_button)
        ...
        signup_button_window = self.canvas.create_window(10, 108, anchor=tk.NW, window=signup_button)
        ...
        helpdesk_button_window = self.canvas.create_window(400, 10, anchor=tk.NW, window=helpdesk_button)
        ...
        guide_button_window = self.canvas.create_window(615, 10, anchor=tk.NW, window=guide_button)
...
class MainApplication(tk.Tk):
    ...
    def show_login(self):
        ...
        subprocess.run(["python", "C:/Users/depak/Scrapy-X/src/login.py"])

    def show_signup(self):
        subprocess.run(["python", "C:/Users/depak/Scrapy-X/src/register.py"])

    def show_helpdesk(self):
        subprocess.run(["python", "C:/Users/depak/Scrapy-X/src/helpdesk.py"])

    def show_dashboard(self):
        subprocess.run(["python", "C:/Users/depak/Scrapy-X/src/dashbord.py"])


    def show_mainpage(self):
        subprocess.run(["python", "C:/Users/depak/Scrapy-X/src/Srapeyard.py"])


    def show_guide(self):
        subprocess.run(["python", "C:/Users/depak/Scrapy-X/src/guide.py"])
